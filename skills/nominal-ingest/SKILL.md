...
- `<API_HOST>`: ask the user — this is environment-specific and you cannot guess it. Real examples:
  - SaaS gov tenant: `api.gov.nominal.io`
  - SaaS gov staging: `api-staging.gov.nominal.io`
  - Self-hosted: `api.nominal.<customer-domain>` (e.g. `api.nominal.acme.com`)
